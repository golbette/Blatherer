...
/**
 * Put async task class for backend
...
public class PutAsyncTask extends AsyncTask<Void, String, String> {
    ...
    /**
     * Helper class for building PutAsyncTasks
     */
    public static class Builder {
        ...
        /**
         * Constructs a PutPostAsyncTask with the current attributes.
         *
         * @return a PutPostAsyncTask with the current attributes
         */
    ...
    /**
     * Constructs a PutPostAsyncTask internally from a builder
     *
    ...
    /**
     * Override do in background for put task
