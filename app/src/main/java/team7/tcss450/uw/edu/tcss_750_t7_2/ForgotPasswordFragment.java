 ...
 * {@link ForgotPasswordFragment.OnForgotFragmentInteractionListener} interface
...
public class ForgotPasswordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText enteredEmail = view.findViewById(R.id.forgot_pw_email);

        Button resetButt = view.findViewById(R.id.forgot_pw_send);
        resetButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEmail = enteredEmail.getText().toString();

                if (mEmail.contains("@")) {
                    mListener.onResetClicked(mEmail);
                } else {
